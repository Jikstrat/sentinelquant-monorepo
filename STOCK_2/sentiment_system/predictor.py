...
MODEL_PATH = os.path.join(_ROOT, "models", "random_forest_model.pkl")


# -------------------------
# LOAD MODELS (LAZY SINGLETON — works outside Streamlit/FastAPI)
# -------------------------

_model_lock = threading.Lock()
_model_bundle: Optional[Tuple[object, object, object]] = None
...
def load_models():
    ...
    with _model_lock:
        if _model_bundle is None:
            ...
            _model_bundle = (model, tokenizer, sentiment_model)
...
def analyze_sentiment(headlines):
    ...
    _, tokenizer, sentiment_model = load_models()
